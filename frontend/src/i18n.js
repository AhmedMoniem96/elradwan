...
const resources = {
  ...
  ar: {
    translation: {
      ...
      ,"reset_password_confirm_description": "افتح الرابط من البريد الإلكتروني ثم أدخل كلمة المرور الجديدة."
      ,"reset_password_token": "رمز إعادة التعيين"
      ,"reset_password_uid": "معرّف إعادة التعيين"
      ,"reset_password_uid_helper": "اختياري إذا تم إدخال البريد الإلكتروني."
      ...
      ,"suppliers_balances_overview": "نظرة عامة على أرصدة الموردين"
      ,"suppliers_balances_overview_subtitle": "ملخص سريع للالتزامات الحالية والمتأخرة للموردين."
      ...
      ,"suppliers_payment_amount_required": "أدخل مبلغ دفعة أكبر من صفر"
